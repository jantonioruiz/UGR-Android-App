...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull RelativeLayout rootView,
      @NonNull FrameLayout compassContainer, @NonNull ImageView compassImageView) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((RelativeLayout) rootView, compassContainer, compassImageView);
    }
